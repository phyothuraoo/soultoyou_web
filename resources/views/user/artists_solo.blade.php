<!DOCTYPE html>
    ...
    <div class="container" style="position: absolute;width: 1130px;height: 420px;left: 156px;top: 160px;background: #FFFFFF;margin-bottom: 112px;">
                            ...
                            <div id="left" style="display: flex;flex-direction: row;justify-content: center;align-items: center;padding: 0px;gap: 48px;width: 650px;height: 24px;flex: none;order: 0;flex-grow: 0;">
                                <div id="right" style="display: flex;flex-direction: row;justify-content: flex-end;align-items: center;padding: 0px;gap: 34px;width: 650px;height: 24px;border-radius: 0px;flex: none;order: 0;flex-grow: 0;">
                                    <ul class="nav" style="display: flex;flex-direction: row;align-items: center;padding: 0px;gap: 34px; width: 650px;height: 24px;border-radius: 0px;flex: none;order: 0;flex-grow: 0;">
                                        ...
                                        <li style="display: flex;flex-direction: row;align-items: center;padding: 0px;gap: 4px;width: 20px;height: 24px;border-radius: 0px;flex: none;order: 0;flex-grow: 0;margin: 0px 60px;">
                                            <a href="{{ url('/artists/girlgroup') }}" style="height: 24px;font-family: 'Poppins';font-style: normal;font-weight: 500;font-size: 16px;line-height: 24px;color: rgba(99, 107, 120, 0.5);flex: none;order: 0;flex-grow: 0;margin-top: 0px;text-decoration: none;">Girl Groups</a>
                                            <p style="width: 18px;height: 0px;border: 0.5px solid #A1A6AD;transform: rotate(90deg);flex: none;order: 1;flex-grow: 0;margin:0px 34px"></p>
                                        </li>
                                        <li style="flex-direction: row;align-items: center;padding: 0px;gap: 4px;height: 24px;border-radius: 0px;flex: none;order: 0;flex-grow: 0;margin-left: 60px;">
                                            <a href="{{ url('/artists/solo') }}" style="width: 20px;height: 24px;font-family: 'Poppins';font-style: normal;font-weight: 500;font-size: 16px;line-height: 24px;color: #F06C5C;flex: none;order: 0;flex-grow: 0;margin-top: 0px;text-decoration: none;">Solo Artists</a>
                                        </li>
        ...
        <div class="row mt-3">
            <div class="col" style="width: 1128px;height: 450px;flex: none;order: 0;flex-grow: 0;margin-left: -10px;">
                <!-- <img src="../assets/img/solo_artists/JEONSOMI.png" style="width: 100%;height: 100%;"></img> -->
                <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="../assets/img/solo_artists/JEONSOMI.png" class="d-block w-100" alt="...">
                      </div>
                    ...
                    <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="prev" style="margin-left: -83px;">
                      <!-- <span class="carousel-control-prev-icon" aria-hidden="true"></span> -->
                      <img src="../assets/img/solo_artists/left-circle.svg" alt="...">
                      <span class="visually-hidden">Previous</span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="next" style="margin-right: -84px;">
                      <!-- <span class="carousel-control-next-icon" aria-hidden="true"></span> -->
                      <img src="../assets/img/solo_artists/right-circle.svg" alt="...">
        ...
        <div class="row mt-3" style="padding-top:0px;">
            <div class="col" style="display: flex;flex-direction: column;align-items: flex-start;padding: 16px 0px 0px;gap: 20px;width: 864px; flex: none;order: 0;flex-grow: 0;">
                <div class="col" style="display: flex;flex-direction: row; align-items: flex-start;padding: 24px 0px 0px;gap: 24px; width: 824px; height: 106px; border-radius: 0px;flex: none; order: 0;flex-grow: 0;justify-content: center;align-items: center;">
                    ...
                    <div class="row" style="display: flex;flex-direction: row;justify-content: space-between;align-items: center;gap: 14px; width: 434px;height: 68px;background: #FFFFFF;flex: none; order: 1;flex-grow: 0;margin-left: 135px;margin-top: 39px;">
                        <div class="col" style="display: flex;flex-direction: row;justify-content: space-between;align-items: center;padding: 0px;width: 444px;height: 24px;flex: none;order: 0;flex-grow: 0;margin-bottom: 3px;margin-left: -10px;">
                            <p style="width: 57px;height: 24px;font-family: 'Poppins';font-style: normal;font-weight: 500;font-size: 16px;line-height: 24px;color: #636B78;flex: none;order: 0;flex-grow: 0;margin-top: 15px;">
                                Search
                            </p>
                            <img src="../assets/img/solo_artists/ep_search.svg" style="width: 24px;height: 24px;flex: none;order: 1;flex-grow: 0;" alt=""><br>
                        </div>
                        <div class="col" style="width: 444px;margin-left: -10px;">
                            <p style="width: 432px;height: 0px;border: 0.8px solid #2CB9C1;flex: none;order: 1;flex-grow: 0;margin-left: -10px;"></p>
                        </div>
                    </div>
                </div>

                @foreach($solo_bands as $n)
                <div style="display: flex;flex-direction: row; align-items: flex-start;padding: 24px 0px 0px;gap: 16px; width: 834px;height: 369px;border-radius: 0px;flex: none;order: 1;flex-grow: 0;">
                    <img src="{{ asset('/bands_images/'.$n->main_image) }}" alt="" style="width:354px;height:351px;">
    ...
    <footer class="bg-light text-center text-lg-start mt-5" style="margin-top: 2500px !important;" id="footer">
