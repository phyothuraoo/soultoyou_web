    ...
    <div class="container" style="position: absolute;width: 1130px;height: 420px;left: 156px;top: 160px;background: #FFFFFF;margin-bottom: 112px;">
        <div class="row" style="box-sizing: border-box;display: flex;flex-direction: column;align-items: flex-start;padding: 0px;gap: 24px;width: 720px;height: 152px;left: calc(50% - 720px/2 - 204px); bottom: 60.22%;margin-top:72px;">
            <div style="display: flex;flex-direction: row;align-items: center;padding: 0px;gap: 14px;width: 432px;height: 24px;flex: none;order: 0;flex-grow: 0;align-items: center;">
                <img src="assets/img/save_video/air-ballon.png" style="width: 24px;height: 24px;flex: none;order: 0;flex-grow: 0;" alt="">
            ...
            <div style="display: flex;flex-direction: row;align-items: center;padding: 0px;gap: 32px;width: 720px;height: 104px;flex: none;order: 1;flex-grow: 0;">
                <div class="card" style="width: 156px; height: 104px;background: #FFFFFF;box-shadow: 2px 2px 44px rgba(26, 72, 72, 0.1);border-radius: 10px;flex: none;order: 0;flex-grow: 0;">
                    <div class="row">
                        <div class="col" style="position: absolute;width: 36px;height: 36px;left: 0px;top: 0px;background-image: url('assets/img/save_video/newspaper.png');background-repeat: no-repeat;background-size: cover;background-position: center;margin-left: 12px;margin-top: 12px;">
                        </div>
                ...
                <div class="card" style="width: 156px; height: 104px;background: #FFFFFF;box-shadow: 2px 2px 44px rgba(26, 72, 72, 0.1);border-radius: 10px;flex: none;order: 0;flex-grow: 1;border: 1px solid;border-image: linear-gradient(95.06deg, #F9978E -0.14%, #5BDDC7 110.84%) 10;">
                    <div class="row">
                        <div class="col" style="position: absolute;width: 36px;height: 36px;left: 0px;top: 0px;background-image: url('assets/img/save_video/video.png');background-repeat: no-repeat;background-size: cover;background-position: center;margin-left: 12px;margin-top: 12px;">
                        </div>
                ...
                <div class="card" style="box-sizing: border-box;width: 156px; height: 104px;background: #FFFFFF;box-shadow: 2px 2px 44px rgba(26, 72, 72, 0.1);border-radius: 10px;flex: none;order: 0;flex-grow: 2;">
                    <div class="row" style="">
                        <div class="col" style="position: absolute;width: 36px;height: 36px;left: 0px;top: 0px;background-image: url('assets/img/save_video/sound.png');background-repeat: no-repeat;background-size: cover;background-position: center;margin-left: 12px;margin-top: 12px;">
                        </div>
                        <div class="col" style="position: absolute;width: 81px;height: 24px;left: 62px;top: 12px;font-family: 'Poppins';font-style: normal;font-weight: 500;font-size: 18px;line-height: 24px;text-align: right;color: #A1A6AD;">
                            20
                        </div>
                ...
                <div class="card" style="width: 156px; height: 104px;background: #FFFFFF;box-shadow: 2px 2px 44px rgba(26, 72, 72, 0.1);border-radius: 10px;flex: none;order: 0;flex-grow: 3;">
                    <div class="row">
                        <div class="col" style="position: absolute;width: 36px;height: 36px;left: 0px;top: 0px;background-image: url('assets/img/save_video/heart.png');background-repeat: no-repeat;background-size: cover;background-position: center;margin-left: 12px;margin-top: 12px;">
                        </div>
                        <div class="col" style="position: absolute;width: 81px;height: 24px;left: 62px;top: 12px;font-family: 'Poppins';font-style: normal;font-weight: 500;font-size: 18px;line-height: 24px;text-align: right;color: #A1A6AD;">
                            35
                        </div>
        ...
        <div class="row" style="padding-top:0px;margin-top: 46px;">
            <div class="col" style="display: flex;flex-direction: column;align-items: flex-start;padding: 16px 0px 0px;gap: 0px;width: 864px; flex: none;order: 0;flex-grow: 0;">
                <div class="col" style="display: flex;flex-direction: row;align-items: flex-start;padding: 0px;gap: 24px;width: 736px;height: 36px;flex: none;order: 0;flex-grow: 0;margin-bottom: 42px;">
                    <p style="width: 200px;height: 36px;font-family: 'Poppins';font-style: normal;font-weight: 600;font-size: 24px;line-height: 36px;color: #2CB9C1;flex: none;order: 0;flex-grow: 0;">Saved Videos</p>
                </div>
                <div style="display: flex;flex-direction: row; align-items: flex-start;padding: 24px 0px 0px;gap: 24px; width: 820px;height: 414px;flex: none;order: 1;flex-grow: 0;">
                    <div style="display: flex;flex-direction: row;justify-content: space-between ;align-items: center;padding: 0px;gap: 24px; width: 820px;height: 366px;flex: none;order: 0;flex-grow: 0;">
                ...
                <div style="display: flex;flex-direction: row; align-items: flex-start;padding: 24px 0px 0px;gap: 24px; width: 820;height: 424px;flex: none;order: 2;flex-grow: 0;">
                ...
                <div style="display: flex;flex-direction: row; align-items: flex-start;padding: 24px 0px 0px;gap: 24px; width: 820;height: 424px;flex: none;order: 3;flex-grow: 0;">
                    <div style="display: flex;flex-direction: row;justify-content: space-between ;align-items: center;padding: 0px;gap: 24px; width: 820;height: 366px;flex: none;order: 0;flex-grow: 0;">
                        <div style="display: flex;flex-direction: column;align-items: flex-start;padding: 0px;width: 399.57px;height: 366px;flex: none;order: 0;flex-grow: 0;">
                            <div class="col" style="width: 400px;height: 236px;background: #FFFFFF;flex: none;order: 0;flex-grow: 0;background-image: url('assets/img/save_video/video_frame.png');background-position: center;background-size: cover;background-repeat: no-repeat;">
                            </div>
            ...
            <div class="col" style="display: flex;flex-direction: row;align-items: flex-start;padding: 15px 0px 0px; width: 264px;height: 934px;border-radius: 0px;flex: none;order: 1;flex-grow: 0;">
                <div class="col-12">
                    <div class="col" style="width:245px;height:420px;flex:none;order:0;flex-grow:0;background-image: url('assets/img/ads.png');background-position: center;background-repeat: no-repeat;background-size: cover;">
                    </div>
