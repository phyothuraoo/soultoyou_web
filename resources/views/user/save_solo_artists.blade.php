    ...
    <div class="container" style="position: absolute;width: 1130px;height: 420px;left: 156px;top: 160px;background: #FFFFFF;margin-bottom: 112px;">
        <div class="row" style="box-sizing: border-box;display: flex;flex-direction: column;align-items: flex-start;padding: 0px;gap: 24px;width: 720px;height: 152px;left: calc(50% - 720px/2 - 204px); bottom: 60.22%;margin-top:72px;">
            <div style="display: flex;flex-direction: row;align-items: center;padding: 0px;gap: 14px;width: 432px;height: 24px;flex: none;order: 0;flex-grow: 0;align-items: center;">
                <img src="assets/img/save_solo/air-ballon.png" style="width: 24px;height: 24px;flex: none;order: 0;flex-grow: 0;" alt="">
            ...
            <div style="display: flex;flex-direction: row;align-items: center;padding: 0px;gap: 32px;width: 720px;height: 104px;flex: none;order: 1;flex-grow: 0;">
                <div class="card" style="width: 156px; height: 104px;background: #FFFFFF;box-shadow: 2px 2px 44px rgba(26, 72, 72, 0.1);border-radius: 10px;flex: none;order: 0;flex-grow: 0;">
                    <div class="row">
                        <div class="col" style="position: absolute;width: 36px;height: 36px;left: 0px;top: 0px;background-image: url('assets/img/save_solo/newspaper.png');background-repeat: no-repeat;background-size: cover;background-position: center;margin-left: 12px;margin-top: 12px;">
                        </div>
                ...
                <div class="card" style="width: 156px; height: 104px;background: #FFFFFF;box-shadow: 2px 2px 44px rgba(26, 72, 72, 0.1);border-radius: 10px;flex: none;order: 0;flex-grow: 1;">
                    <div class="row">
                        <div class="col" style="position: absolute;width: 36px;height: 36px;left: 0px;top: 0px;background-image: url('assets/img/save_solo/video.png');background-repeat: no-repeat;background-size: cover;background-position: center;margin-left: 12px;margin-top: 12px;">
                        </div>
                ...
                <div class="card" style="box-sizing: border-box;width: 156px; height: 104px;background: #FFFFFF;box-shadow: 2px 2px 44px rgba(26, 72, 72, 0.1);border-radius: 10px;flex: none;order: 0;flex-grow: 2;">
                    <div class="row" style="">
                        <div class="col" style="position: absolute;width: 36px;height: 36px;left: 0px;top: 0px;background-image: url('assets/img/save_solo/sound.png');background-repeat: no-repeat;background-size: cover;background-position: center;margin-left: 12px;margin-top: 12px;">
                        </div>
                        <div class="col" style="position: absolute;width: 81px;height: 24px;left: 62px;top: 12px;font-family: 'Poppins';font-style: normal;font-weight: 500;font-size: 18px;line-height: 24px;text-align: right;color: #A1A6AD;">
                            20
                        </div>
                ...
                <div class="card" style="width: 156px; height: 104px;background: #FFFFFF;box-shadow: 2px 2px 44px rgba(26, 72, 72, 0.1);border-radius: 10px;flex: none;order: 0;flex-grow: 3;border: 1px solid;border-image: linear-gradient(95.06deg, #F9978E -0.14%, #5BDDC7 110.84%) 10;">
                    <div class="row">
                        <div class="col" style="position: absolute;width: 36px;height: 36px;left: 0px;top: 0px;background-image: url('assets/img/save_solo/heart.png');background-repeat: no-repeat;background-size: cover;background-position: center;margin-left: 12px;margin-top: 12px;">
                        </div>
                        <div class="col" style="position: absolute;width: 81px;height: 24px;left: 62px;top: 12px;font-family: 'Poppins';font-style: normal;font-weight: 500;font-size: 18px;line-height: 24px;text-align: right;color: #A1A6AD;">
                            35
                        </div>
        ...
        <div class="row" style="padding-top:0px;margin-top: 46px;">
            <div class="col" style="display: flex;flex-direction: column;align-items: flex-start;padding: 16px 0px 0px;gap: 0px;width: 864px; flex: none;order: 0;flex-grow: 0;">
                <div class="col" style="display: flex;flex-direction: row;align-items: flex-start;padding: 0px;gap: 24px;width: 736px;height: 36px;flex: none;order: 0;flex-grow: 0;margin-bottom: 42px;">
                ...
                <div style="display: flex;flex-direction: row; align-items: flex-start;padding: 0px 0px 0px;gap: 16px; width: 834px;height: 370px;border-radius: 0px;flex: none;order: 1;flex-grow: 0;">
                    <img src="assets/img/solo_artists/band_image1.png" alt="" style="width:354px;height:351px;">
                ...
                <div style="display: flex;flex-direction: row; align-items: flex-start;margin-top: 15px;margin-bottom: 20px;gap: 16px; width: 834px;height: 351px;border-radius: 0px;flex: none;order: 1;flex-grow: 0;">
                    <img src="assets/img/solo_artists/band_image2.png" alt="" style="width:354px;height:351px;">
                    <div style="display: flex;flex-direction: column;justify-content: center; align-items: flex-start; padding: 10px;gap: 24px;width: 456px;height: 345px; border-radius: 0px; flex: none;order: 1;flex-grow: 0;">
                        <div class="col" style="display: flex;flex-direction: column;align-items: flex-start;padding: 0px;gap: 20px;width: 436px;height: 209px;border-radius: 0px;flex: none;order: 0;align-self: stretch;flex-grow: 0;">
                            <div style="display: flex;flex-direction: row;justify-content: space-between;align-items: center;padding: 0px;gap: 10px;width: 436px;height: 29px;flex: none; order: 0;flex-grow: 0;">
                                <p style="width: 160px;height: 29px;font-family: 'Inter';font-style: normal;font-weight: 600;font-size: 24px;line-height: 45px;color: #0A2942;flex: none;order: 0;flex-grow: 0;">
                ...
                <hr style="width: 824px;height: 0px;border: 1px solid #A1A6AD;flex: none;order: 1;flex-grow: 0;">
                <div style="display: flex;flex-direction: row; align-items: flex-start;margin: 15px 0px;gap: 16px; width: 834px;height: 351px;border-radius: 0px;flex: none;order: 1;flex-grow: 0;">
                    <img src="assets/img/solo_artists/band_image3.png" alt="" style="width:354px;height:351px;">
                    <div style="display: flex;flex-direction: column;justify-content: center; align-items: flex-start; padding: 10px;gap: 24px;width: 456px;height: 345px; border-radius: 0px; flex: none;order: 1;flex-grow: 0;">
                        <div class="col" style="display: flex;flex-direction: column;align-items: flex-start;padding: 0px;gap: 20px;width: 436px;height: 209px;border-radius: 0px;flex: none;order: 0;align-self: stretch;flex-grow: 0;">
                            <div style="display: flex;flex-direction: row;justify-content: space-between;align-items: center;padding: 0px;gap: 10px;width: 436px;height: 29px;flex: none; order: 0;flex-grow: 0;">
                                <p style="width: 150px;height: 29px;font-family: 'Inter';font-style: normal;font-weight: 600;font-size: 24px;line-height: 45px;color: #0A2942;flex: none;order: 0;flex-grow: 0;">
                                    JEON SOMI
                                </p>
                                <img src="assets/img/artists/More Icon.svg" alt="">
                            </div>
            ...
            <div class="col" style="display: flex;flex-direction: row;align-items: flex-start;padding: 15px 0px 0px; width: 264px;height: 934px;border-radius: 0px;flex: none;order: 1;flex-grow: 0;">
                <div class="col-12">
                    <div class="col" style="width:245px;height:425px;flex:none;order:0;flex-grow:0;background-image: url('assets/img/ads.png');background-position: center;background-repeat: no-repeat;background-size: cover;">
                    </div>
                    <div class="col" style="margin-top: 24px;width:245px;height:425px;flex:none;order:0;flex-grow:0;background-image: url('assets/img/ads.png');background-position: center;background-repeat: no-repeat;background-size: cover;">
                    </div>
                    <div class="col" style="margin-top:24px;width:245px;height:425px;flex:none;order:0;flex-grow:0;background-image: url('assets/img/ads.png');background-position: center;background-repeat: no-repeat;background-size: cover;">
                    </div>
                </div>
